    ...
    <div class="policy-card mb-6" id="card-${p.id}" style="border-left: 16px solid ${brandColor}; border-color: ${brandColor};">
        ...
        <div class="content-area p-6" style="background: linear-gradient(to bottom, ${brandBg}, #ffffff)">
            <div class="detail-grid grid grid-cols-3 gap-5 mb-10">
                ...
                ${isULIP ? `<div class="detail-item bg-indigo-50 border-2 border-indigo-500 rounded-xl p-2"><p class="text-indigo-700 font-bold text-[10px]">Portfolio Value</p><p class="font-black text-lg">${autoFmt(unitValue, sym)}</p></div>` : `<div class="detail-item"><p>Customer ID</p><p>${p.clientId || 'N/A'}</p></div>`}
            </div>
