/* component_sg.js - v7.0.5 - Final Master Build: Excel Math + India Curvature + Precise Countdown */
...
export function createSGCard(p, sym, TODAY, CURRENT_YEAR) {
    ...
    // --- 1. PRECISION COUNTDOWN LOGIC (XXyXXm) ---
    ...
    if (isPaidUp) {
        ...
        // Calculate based on the MIP year parsed by loader.js
    ...
    // --- 4. NOMINEE UI (With Blink for Unassigned) ---
    let nomineeHtml = "";
    ...
    // Capital Analysis (Same as India style)
